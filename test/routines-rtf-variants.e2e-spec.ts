...
describe('RtF Variant Routine Creation (e2e)', () => {
	...
	it('POST /api/routines creates routine mixing PROGRAMMED_RTF and PROGRAMMED_RTF_HYPERTROPHY', async () => {
		...
		const returned = res.body.days[0].exercises.map((e: any) => e.progressionScheme)
