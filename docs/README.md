...
| Resource                                 | Path                                                        | Type   | Purpose                                    | Last Updated |
| ---------------------------------------- | ----------------------------------------------------------- | ------ | ------------------------------------------ | ------------ |
| TM Adjustment DTO + Contracts Follow-ups | `./history/2026-01-18-tm-adjustment-dto-typed-constants.md` | Report | DTO lint fix and contracts alignment notes | 2026-01-18   |
